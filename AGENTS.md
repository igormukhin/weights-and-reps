...
- TypeScript 6.x (strict mode) + Vue 3 (Composition API), Vuetify 4, Pinia, Firebase SDK v12+
...
└── views/                  # LoginView, ExercisesView, ExercisesEditView, ExerciseDetailView
firestore.rules
```
...
npm run lint    # TypeScript check (vue-tsc)
