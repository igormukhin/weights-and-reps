 ...
 * Branch: 001-training-tracker-app
 * Date: 2026-03-20
 *
 * These interfaces define the shape of data flowing through the app.
 * They are the contract between the Firestore service layer and the UI layer.
 * Any change to Firestore document structure MUST be reflected here.
 */
